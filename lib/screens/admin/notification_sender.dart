...
class SenderState extends State<Sender>{
  ...
  void executeNotification(){
    ...
    Firestore.instance.collection("Notifications").add(notificationData).then((_){
        ...
        children: <Widget>[
          SingleChildScrollView(
              ...
              child: Container(
                ...
                child: Column(children: <Widget>[
                  Padding(
                    ...
                    child: Text("Send a Notification", style: TextStyle(fontFamily: 'Lato', fontSize: 25), textAlign: TextAlign.left,),
                  ),
                  Padding(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: DropdownButton(
                        value: filter,
                        isExpanded: true,
                        hint: Text("Send Notification to Specific Committie"),
                        ...
                        onPressed: (){
                          DatePicker.showDatePicker(
                            ...
                            onChanged: (DateTime dateTime){
                              setState((){
                                date = new DateFormat('yyyy-MM-dd').format(dateTime).toString();;
                              });
                            }
                          );
                        },
           ...
           FlatButton(
                        ...
                        Text("Don't send as reminder", 
                        style: TextStyle(
                          color: Colors.red,
                          fontSize: 14
                        ),),
                        onPressed: date == null ? ()=> print("Nothing shall happen") :
                        (){
                          setState(()=> date = null);
                        }
                        ,
                      ...
                      child: FlatButton(
                        ...
                        onPressed: (){
                          try{
                            ...
                            _scaffoldKey.currentState.showSnackBar(
                              SnackBar(
                                content: Text(error.toString(), style: TextStyle(
                                  color: Colors.white
                                )),
