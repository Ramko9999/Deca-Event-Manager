      ...
      children: <Widget>[
        Container(
          ...
          child: Column(children: <Widget>[
            ...
            Flexible(
                child: userDocs == null ? CircularProgressIndicator() : getList(context)
            ),
          ]
          ),
        ),
                  ...
                  if(infoContainer.eventMetadata['enter_type'] == 'QE')
                    {
                      ...
                      Scaffold.of(context).showSnackBar(
                          SnackBar(content:
                          Text("Succesfully added ${eventMetaData['gold_points'].toString()} to ${userInfo['first_name']}", style:
                          TextStyle(
                              fontFamily: 'Lato',
                              fontSize: 20,
                              color: Colors.white
      ...
      actions: <Widget>[
        FlatButton(
          ...
          onPressed: () {
            ...
            Scaffold.of(context).showSnackBar(
                SnackBar(content:
                Text("Succesfully added ${points.toString()} to ${userData['first_name']}", style:
                TextStyle(
                    fontFamily: 'Lato',
                    fontSize: 20,
                    color: Colors.white
